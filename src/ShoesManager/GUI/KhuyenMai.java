...
public class KhuyenMai extends javax.swing.JFrame  implements MouseListener{
    ...
    private void initComponents() {
        ...
        cbbThongTin_Loai.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Type 1", "Type 2", "Type 3" }));

        cbbThongTin_DK.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        cbbThongTin_DK.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Normal", "Special", "VIP" }));

        lblThongTin_NgayBan1.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        lblThongTin_NgayBan1.setForeground(colorText);
        lblThongTin_NgayBan1.setText("End Day");
        ...
        lblChiTiet_ChiTietHoaDon.setText("Promotion Detail");
        ...
        lblChiTiet_MaHD.setText("ID Promotion");
        ...
        lblChiTiet_TiLeKM.setText("Promotional Rate");
        ...
        lblChiTiet_SoLuong2.setText("Prinotional Rate");
        ...
        pCenterLayout.setHorizontalGroup(
            ...
            .addGroup(pCenterLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(pChiTiet, javax.swing.GroupLayout.PREFERRED_SIZE, 806, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//        HoaDonDTO hd = new HoaDonDTO();
    ...
    private void createVectorHeader() {
        if (model.getRowCount()==0) {
            ...
            header.add("Type Program");
            header.add("Name Program");
            header.add("Condition");
            header.add("Start Day");
            header.add("End Day");
