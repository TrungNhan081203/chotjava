...
public class Home extends JFrame{
    ...
    public void init() throws Exception {
        ...
        lblHoten = new JLabel("Name:" + nhanvien.getStrHo() 
                + " " + nhanvien.getStrTen());
        lblRole = new JLabel("Position:" + nhanvien.getStrChucVu());
        ...
        lblHoadon.setIcon(new ImageIcon("./src/ShoesManager/images/hoadon.png"));
        lblKhuyenmai.setBounds(488, 150, 303, 131);
        lblKhuyenmai.setIcon(new ImageIcon("./src/ShoesManager/images/khuyenmai.png"));
        lblHanghoa.setBounds(841, 150, 303, 131);
        lblHanghoa.setIcon(new ImageIcon("./src/ShoesManager/images/hanghoa.png"));
        lblNhaphang.setBounds(135, 331, 303, 131);
        lblNhaphang.setIcon(new ImageIcon("./src/ShoesManager/images/nhaphang.png"));
        lblThongke.setBounds(488, 331, 303, 131);
        lblThongke.setIcon(new ImageIcon("./src/ShoesManager/images/thongke.png"));
        lblXuatexcel.setBounds(841, 331, 303, 131);
        lblXuatexcel.setIcon(new ImageIcon("./src/ShoesManager/images/xuat.png"));
        ...
        lblXuatexcel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent me) {
                ...
                dm.setVisible(true);
                setVisible(false);
                lblKhuyenmai.setIcon(new ImageIcon("./src/ShoesManager/images/xuat.png"));
            }
            @Override
            public void mousePressed(MouseEvent me) {
                lblXuatexcel.setIcon(new ImageIcon("./src/ShoesManager/images/xuat.png"));
